...
activities = {
    ...
    "Swimming Team": {
        "description": "Competitive swim practice and meets for all skill levels",
    ...
    "Drama Club": {
        "description": "Acting, stagecraft, and performance opportunities for students",
        "schedule": "Fridays, 3:45 PM - 5:30 PM",
        "max_participants": 24,
        "participants": ["sophia@mergington.edu", "liam@mergington.edu"]
    },
    "Math Olympiad": {
        "description": "Challenge your problem-solving skills with advanced math contests",
        "schedule": "Wednesdays, 3:30 PM - 4:30 PM",
        "max_participants": 15,
        "participants": ["emma@mergington.edu", "jack@mergington.edu"]
    },
    "Debate Team": {
        "description": "Practice public speaking and critical thinking in competitive debates",
